...
@section('title', 'Maid bills — Mess App')

@section('content')
    <form method="get" action="{{ route('maid-bills.index') }}"
        ...
        <div class="min-w-0 flex-1 sm:max-w-xs">
            <label for="maid-bills-month-filter" class="block text-xs font-semibold uppercase tracking-wider text-slate-500">Filter by month</label>
            <input type="month" name="month" id="maid-bills-month-filter" value="{{ $month }}"
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-slate-900">Maid bills</h1>
