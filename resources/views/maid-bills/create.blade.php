...
@section('content')
    <div class="mx-auto max-w-lg">
        ...
        <p class="mt-1 text-sm text-slate-500">Record a maid bill for a member. Month uses <code class="rounded bg-gray-100 px-1.5 py-0.5 text-xs font-medium text-slate-700">Y-m</code> format.</p>
        ...
        <form action="{{ route('maid-bills.store') }}" method="post" class="form-card" novalidate>
            ...
            <div>
                ...
                <input type="text" name="amount" id="maid-bill-amount" value="{{ old('amount') }}"
